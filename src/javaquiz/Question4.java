...
public class Question4 extends javax.swing.JFrame {
    int quizans = 0;
    int marks = 0;
    public Question4(int qzans, int m) {
        initComponents();
        this.quizans = qzans;
        this.marks = m;
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("How many seconds make one hour?");

        btnGroup1.add(jrbtn1);
        jrbtn1.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
        jrbtn1.setText("3600 seconds");
        ...
        btnSubmit.setText("Finished & Submit");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jrbtn3)
                                    .addComponent(btnCheckAnswer, javax.swing.GroupLayout.Alignment.TRAILING))
                                .addGap(18, 18, 18)
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        if (!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected()){
            ...
            quizans = quizans + 1;
            new Result(quizans,marks).setVisible(true);
            this.dispose();
      }
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        if (!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected()){
            ...
            if(jrbtn1.isSelected()){
             ...
             JOptionPane.showMessageDialog(null,"Wrong Answer! The Answer is 3600 seconds");
            }
