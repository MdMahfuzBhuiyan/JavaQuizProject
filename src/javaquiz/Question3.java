...
public class Question3 extends javax.swing.JFrame {
    int quizans = 0;
    int marks = 0;
    public Question3(int qzans, int m) {
        initComponents();
        this.quizans = qzans;
        this.marks = m;
    }
    ...
    if (!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected()){
           ...
           quizans = quizans + 1;
            new Question4(quizans,marks).setVisible(true);
            this.dispose();
      }        
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        if (!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected()){
            ...
            if(jrbtn2.isSelected()){
             ...
             JOptionPane.showMessageDialog(null,"Wrong Answer! The Answer is Mango");
            }
